...
Private HTTP/Streamable transport wrapper around `@aifinpay/mcp` for `https://mcp.aifinpay.io/mcp` (catalog listings that require a public URL).
...
## Rules
- Keep package `private: true` — never publish to npm.
