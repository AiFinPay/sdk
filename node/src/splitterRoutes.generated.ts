...
import { arbitrum, avalanche, base, bsc, optimism, polygon, polygonAmoy, unichain } from "viem/chains";
...
export const SPLITTER_REGISTRY_SOURCE = {
  ...
  commit: "64e245fd613e97f95195239238d6ac75484a8a21",
  artifactSha256: "36ee672b1deccd7b851460b459af26984ca07802477bc8c1e78018f5d5154827",
  schemaVersion: 4,
...
export const SPLITTER_ROUTES: Record<SplitterRouteKey, SplitterRouteDeployment> = {
  "amoy:agent-x402": {
    ...
    splitter: "0xFd1622847A89FB3De240d64DFCbd09C65c77D99d",
    owner: "0x000035156F0cff1b4C36854773472fe0bd258E4d",
    treasury: "0x000035156F0cff1b4C36854773472fe0bd258E4d",
    treasuryBps: 0,
    ipCreatorBps: 0,
    ...
    testnet: true,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0x41E94Eb019C0762f9Bfcf9Fb1E58725BfB0e7582","USDT":null},
    validFrom: "2026-08-29T00:00:00.000Z",
    validUntil: "2026-11-27T00:00:00.000Z",
  ...
  "amoy:merchant-aifp1": {
    ...
    chainId: 80002,
    viemChain: polygonAmoy,
    splitter: "0xdB772E64F63854bf31f2366BF27e47D5699fe7fC",
    owner: "0x000035156F0cff1b4C36854773472fe0bd258E4d",
    treasury: "0x000035156F0cff1b4C36854773472fe0bd258E4d",
    treasuryBps: 100,
    ipCreatorBps: 0,
  ...
  "arbitrum:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0xaf88d065e77c8cC2239327C5EDb3A432268e5831","USDT":null},
  ...
  "avalanche:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E","USDT":"0x9702230a8ea53601f5cd2dc00fdbc13d4df4a8c7"},
    validFrom: "2026-08-27T00:00:00.000Z",
    validUntil: "2026-11-25T00:00:00.000Z",
  ...
  "base:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913","USDT":null},
    validFrom: "2026-08-27T00:00:00.000Z",
    validUntil: "2026-11-25T00:00:00.000Z",
  ...
  "optimism:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85","USDT":null},
    validFrom: "2026-08-27T00:00:00.000Z",
    validUntil: "2026-11-25T00:00:00.000Z",
  ...
  "polygon:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359","USDT":null},
    validFrom: "2026-08-27T00:00:00.000Z",
    validUntil: "2026-11-25T00:00:00.000Z",
  ...
  "unichain:agent-x402": {
    ...
    testnet: false,
    rpcQuorum: 2,
    stablecoins: {"USDC":"0x078D782b760474a361dDA0AF3839290b0EF57AD6","USDT":null},
    validFrom: "2026-08-27T00:00:00.000Z",
    validUntil: "2026-11-25T00:00:00.000Z",
