...
const BASE: Aifp1Quote = {
  ...
  native_settlement: {
    ...
    decimals: 18,
    rate_usd: "0.20",
    total_wei: "1055375555391386000",
    merchant_wei: "1044821799837472120",
    treasury_wei: "10553755553913860",
    creator_wei: "0",
  },
  settlement: {
    batch_units: "200",
...
describe("describeQuote", () => {
  ...
  it("converts wei with no float — the on-chain amount is exact", () => {
    ...
    const s = describeQuote({
      ...BASE,
      native_settlement: { ...BASE.native_settlement!, total_wei: "1000000000000000000" },
    });
